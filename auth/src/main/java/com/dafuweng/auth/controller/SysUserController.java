...
public class SysUserController {
    ...
    @GetMapping("/page")
    public Result<PageResponse<SysUserVO>> pageList(PageRequest request) {
    ...
    /**
     * 批量查询用户信息（根据ID列表）
     * POST /api/sysUser/batch
     */
    @PostMapping("/batch")
    public Result<List<SysUserEntity>> listByIds(@RequestBody List<Long> ids) {
        return Result.success(sysUserService.listByIds(ids));
    }
