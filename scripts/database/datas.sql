...
INSERT IGNORE INTO sys_user (id, username, password, real_name, phone, email, dept_id, zone_id, status, login_error_count, lock_time, last_login_time, last_login_ip, created_by, created_at, updated_by, updated_at, deleted, version) VALUES
-- 正常用户
...
-- 用户-角色关联
INSERT IGNORE INTO sys_user_role (id, user_id, role_id, created_at) VALUES
...
-- 角色-权限关联
INSERT IGNORE INTO sys_role_permission (id, role_id, permission_id, created_at) VALUES
...
-- 战区
INSERT IGNORE INTO sys_zone (id, zone_code, zone_name, director_id, sort_order, status, created_by, created_at, updated_by, updated_at, deleted) VALUES
...
-- 部门
INSERT IGNORE INTO sys_department (id, dept_code, dept_name, parent_id, zone_id, manager_id, sort_order, status, created_by, created_at, updated_by, updated_at, deleted) VALUES
-- 顶级部门
...
-- 边界: 独立于任何战区的部门
(8, 'DEPT_NO_ZONE', '无战区部门', 1, 1, NULL, 5, 1, 1, '2026-03-01 00:00:00', NULL, '2026-03-01 00:00:00', 0);

-- 数据字典
INSERT IGNORE INTO sys_dict (id, dict_type, dict_code, dict_label, dict_value, sort_order, status, remark, created_at, updated_at, deleted) VALUES
-- 客户意向等级
...
-- 系统参数
INSERT IGNORE INTO sys_param (id, param_key, param_value, param_type, param_group, remark, sort_order, status, created_by, created_at, updated_by, updated_at, deleted) VALUES
-- 常规参数
...
-- 操作日志
INSERT IGNORE INTO sys_operation_log (id, user_id, username, module, action, request_method, request_url, request_params, response_code, error_msg, ip, user_agent, cost_time_ms, created_at) VALUES
-- 正常日志
...
-- 公海客户 (长时间未跟进)
(5, '周超', '13900001005', '110101199003033456', NULL, NULL, NULL, 1, 3, 2, 1, 3, 5, '2026-01-01 00:00:00', NULL, '2026-04-01 00:00:00', '超过90天未跟进', NULL, '渠道不明', 100000.00, NULL, 3, '2025-06-01 00:00:00', NULL, '2026-04-01 00:00:00', 0, 1),
-- 边界: 最小金额
...
-- 边界: 无销售负责人的客户
(9, '无负责人客户', '13900001009', '110101199007077890', NULL, NULL, NULL, 1, 3, 2, 1, 2, 1, '2026-04-05 00:00:00', '2026-04-12 00:00:00', NULL, NULL, NULL, '自然到店', 500000.00, '个人消费贷', 3, '2026-04-05 00:00:00', NULL, '2026-04-05 00:00:00', 0, 1),
-- 边界: 身份证号格式错误(15位旧版)
...
-- 联系记录
INSERT IGNORE INTO contact_record (id, customer_id, sales_rep_id, contact_type, contact_date, content, intention_before, intention_after, follow_up_date, attachment_urls, created_by, created_at, updated_by, updated_at, deleted) VALUES
...
-- 合同
INSERT IGNORE INTO contract (id, contract_no, customer_id, sales_rep_id, dept_id, zone_id, product_id, contract_amount, actual_loan_amount, service_fee_rate, service_fee_1, service_fee_2, service_fee_1_paid, service_fee_2_paid, service_fee_1_pay_date, service_fee_2_pay_date, status, sign_date, paper_contract_no, finance_send_time, finance_receive_time, loan_use, guarantee_info, reject_reason, remark, created_by, created_at, updated_by, updated_at, deleted, version) VALUES
-- 正常签约合同
...
-- 边界: 已完成合同
(6, 'HT20260115001', 3, 4, 2, 1, 2, 5000000.00, 4850000.00, 0.0200, 100000.00, 40000.00, 1, 1, '2026-01-15', '2026-02-10', 8, '2026-01-15', 'P20260115001', '2026-01-16 10:00:00', '2026-01-16 14:00:00', '扩大经营', '{"type":"担保人","name":"王保证"}', NULL, 4, '老客户介绍', '2026-01-15 16:00:00', NULL, '2026-04-01 00:00:00', 0, 3);

-- 合同附件
INSERT IGNORE INTO contract_attachment (id, contract_id, attachment_type, file_url, file_name, file_size, file_md5, upload_by, upload_time, deleted) VALUES
...
-- 销售工作日志
INSERT IGNORE INTO work_log (id, sales_rep_id, log_date, calls_made, effective_calls, new_intentions, intention_clients, face_to_face_clients, signed_contracts, content, created_at, updated_at, deleted) VALUES
...
-- 业绩记录
INSERT IGNORE INTO performance_record (id, contract_id, sales_rep_id, dept_id, zone_id, contract_amount, commission_rate, commission_amount, status, calculate_time, confirm_time, grant_time, cancel_reason, remark, created_by, created_at, updated_by, updated_at, deleted) VALUES
...
-- 边界: 已取消
(4, 5, 3, 2, 1, 500000.00, 0.0150, 0, 4, '2026-04-06 10:00:00', NULL, NULL, '合同被拒，取消业绩', '合同未通过审核', 1, '2026-04-06 10:00:00', NULL, '2026-04-06 10:00:00', 0);

-- 客户转移记录
INSERT IGNORE INTO customer_transfer_log (id, customer_id, from_rep_id, to_rep_id, operate_type, reason, operated_by, operated_at, deleted) VALUES
(1, 5, 3, 0, 'public_sea_claim', '超期未跟进，自动流入公海', 2, '2026-04-01 00:00:00', 0),
(2, 9, 0, 3, 'manager_assign', '经理分配', 2, '2026-04-05 09:00:00', 0),
-- 边界: 部门经理调配
...
-- 合作银行
INSERT IGNORE INTO bank (id, bank_code, bank_name, bank_branch, contact_person, contact_phone, status, sort_order, created_by, created_at, updated_by, updated_at, deleted) VALUES
...
(3, 'ABC', '中国农业银行', '北京朝阳支行', '王经理', '13800138003', 1, 3, 1, '2026-01-01 00:00:00', NULL, '2026-01-01 00:00:00', 0),
(4, 'BOC', '中国银行', '上海浦东支行', '张经理', '13800138004', 1, 4, 1, '2026-01-01 00:00:00', NULL, '2026-01-01 00:00:00', 0),
-- 边界: 暂停合作银行
(5, 'COMMUNITY_BANK', '某农村信用社', '广州分行', '刘主任', '13800138005', 0, 99, 1, '2026-02-01 00:00:00', NULL, '2026-03-01 00:00:00', 0);

-- 金融产品
INSERT IGNORE INTO finance_product (id, product_code, product_name, bank_id, min_amount, max_amount, interest_rate, min_term, max_term, requirements, documents, product_features, commission_rate, status, sort_order, online_time, offline_time, created_by, created_at, updated_by, updated_at, deleted) VALUES
...
-- 边界: 已下线产品
(6, 'OLD_PRODUCT_001', '已下线产品', 4, 50000.00, 500000.00, 0.0500, 6, 24, '[]', '[]', '已于2026年3月下线', 0.0100, 0, 99, '2026-01-01 00:00:00', '2026-03-01 00:00:00', 1, '2026-01-01 00:00:00', NULL, '2026-03-01 00:00:00', 0);

-- 贷款审核 (核心复杂表)
INSERT IGNORE INTO loan_audit (id, contract_id, finance_specialist_id, recommended_product_id, approved_amount, approved_term, approved_interest_rate, audit_status, bank_id, bank_audit_status, bank_apply_time, bank_feedback_time, bank_feedback_content, reject_reason, audit_opinion, audit_date, loan_granted_date, actual_loan_amount, actual_interest_rate, created_at, updated_at, deleted) VALUES
-- 状态1: 待接收(新建)
(1, 3, NULL, 1, NULL, 1, NULL, 1, NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-08 10:00:00', '2026-04-08 10:00:00', 0),
-- 状态2: 初审中
(2, 4, 6, 1, NULL, NULL, NULL, 2, 2, 'pending', NULL, NULL, NULL, NULL, '客户资质良好，建议批准', NULL, NULL, NULL, NULL, '2026-04-10 15:00:00', '2026-04-11 09:00:00', 0),
-- 状态3: 已提交银行
...
-- 状态5: 银行拒绝 [终态]
(5, 5, 6, 1, NULL, NULL, NULL, 4, 1, 'rejected', '2026-04-05 15:00:00', '2026-04-06 10:00:00', '企业流水不足', '企业流水不符合银行要求', NULL, NULL, NULL, NULL, NULL, '2026-04-05 14:00:00', '2026-04-06 10:00:00', 0),
-- 状态6: 终审通过-已放款 [终态]
...
-- 状态7: 终审拒绝 [终态]
(7, 7, 6, 1, NULL, NULL, NULL, 7, 5, 'pending', NULL, NULL, NULL, '高风险行业', '行业风险过高，拒绝', '2026-04-09 17:00:00', NULL, NULL, NULL, '2026-04-08 11:00:00', '2026-04-09 17:00:00', 0),
-- 边界: 极端金额
(8, 8, 6, 4, 0.01, 6, 0.0300, 3, 1, 'in_review', '2026-04-13 16:00:00', NULL, NULL, NULL, '边界金额测试', '2026-04-13 16:00:00', NULL, NULL, NULL, '2026-04-13 15:00:00', '2026-04-13 16:00:00', 0);

-- 贷款审核记录
INSERT IGNORE INTO loan_audit_record (id, loan_audit_id, operator_id, operator_name, operator_role, action, content, attachment_urls, created_at) VALUES
...
-- 服务费记录
INSERT IGNORE INTO service_fee_record (id, contract_id, fee_type, amount, should_amount, payment_method, payment_status, payment_date, payment_account, receipt_no, accountant_id, remark, created_at, updated_at, deleted) VALUES
-- 正常已付
...
-- 未付
(4, 4, 1, 0, 9000.00, NULL, 0, NULL, NULL, NULL, 1, '待支付', '2026-04-10 15:00:00', '2026-04-10 15:00:00', 0),
-- 边界: 现金支付
(5, 6, 1, 100000.00, 100000.00, 'cash', 1, '2026-01-15', '现金', 'R20260115001', 1, '一次性现金支付', '2026-01-15 17:00:00', '2026-01-15 17:00:00', 0);

-- 佣金记录
INSERT IGNORE INTO commission_record (id, performance_id, sales_rep_id, contract_id, commission_amount, commission_rate, status, confirm_time, grant_time, grant_account, remark, created_at, updated_at, deleted) VALUES
